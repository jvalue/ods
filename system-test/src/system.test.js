...
describe('System-Test', () => {
  ...
  test('Test 1: Create non-periodic pipeline without transformations', async () => {
    ...
    const pipelineConfig = generateConfig(MOCK_SOURCE_URL+'/data/test1', false)
    let notification = generateNotification('data.one === 1', MOCK_RECEIVER_URL+'/notifications/test1')
  ...
  test('Test 2: Create periodic pipeline without transformations', async () => {
    ...
    const notification = generateNotification('data.count < 2', MOCK_RECEIVER_URL+'/sequences/test2')
    let pipelineConfig = generateConfig(MOCK_SOURCE_URL+'/sequences/test2', true, 3000)
    pipelineConfig.notifications = [notification]
  ...
  test('Test 3: Create non-periodic pipeline with transformations', async () => {
    ...
    const notification = generateNotification('data.newField === 12',MOCK_RECEIVER_URL+'/notifications/test3')
    let pipelineConfig = generateConfig(MOCK_SOURCE_URL+'/data/test3',false)
  ...
  test('Test 4: Update periodic pipeline', async () => {
    ...
    let pipelineConfig = generateConfig(
      MOCK_SOURCE_URL+'/data/test4',true)
    ...
    const notification = generateNotification('data.two === \"two\"', MOCK_RECEIVER_URL+'/notifications/test4')
    pipelineConfig.notifications = [notification]
    pipelineConfig.adapter.location = MOCK_SOURCE_URL+'/data/test4_updated'
  ...
  test('Test 5: Create pipeline with multiple notifications', async () => {
    ...
    let pipelineConfig = generateConfig(MOCK_SOURCE_URL+'/data/test5', false)
    const notification1 = generateNotification('data.one === 1', MOCK_RECEIVER_URL+'/notifications/test5_1')
    const notification2 = generateNotification('data.one === 1', MOCK_RECEIVER_URL+'/notifications/test5_2')
    const notification3 = generateNotification('data.one < 1', MOCK_RECEIVER_URL+'/notifications/test5_3')
    ...
    const webhookResponse1 = await request(MOCK_RECEIVER_URL)
    ...
    const webhookResponse2 = await request(MOCK_RECEIVER_URL)
    ...
    // Check if webhooks were triggered
    const webhookResponse3 = await request(MOCK_RECEIVER_URL)
  ...
  test('Test 6: Delete periodic pipeline', async () => {
    ...
    const notification = generateNotification('data.two === "two"', MOCK_RECEIVER_URL+'/sequences/test6')
    let pipelineConfig = generateConfig(MOCK_SOURCE_URL+'/sequences/test6', true, 5000)
    pipelineConfig.notifications = [notification]
