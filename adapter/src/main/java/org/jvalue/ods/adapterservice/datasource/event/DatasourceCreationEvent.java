...
public class DatasourceCreationEvent extends DatasourceConfigEvent {

    private final DatasourceTrigger trigger;

    public DatasourceCreationEvent(Datasource datasource) {
        super(datasource);
    ...
    public boolean equals(Object o) {
        ...
        DatasourceCreationEvent that = (DatasourceCreationEvent) o;
