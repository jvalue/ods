...
export const AMQP_PIPELINE_CONFIG_EXCHANGE = getEnv('AMQP_PIPELINE_CONFIG_EXCHANGE')
export const AMQP_PIPELINE_CONFIG_QUEUE = getEnv('AMQP_PIPELINE_CONFIG_QUEUE')
export const AMQP_PIPELINE_CONFIG_TOPIC = getEnv('AMQP_PIPELINE_CONFIG_TOPIC')
