...
export const AMQP_PIPELINE_EXECUTION_QUEUE_TOPIC = readEnvOrDie('AMQP_PIPELINE_EXECUTION_QUEUE_TOPIC');
...
export const AMQP_PIPELINE_CONFIG_QUEUE_TOPIC = readEnvOrDie('AMQP_PIPELINE_CONFIG_QUEUE_TOPIC');
