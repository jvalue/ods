...
export const AMQP_PIPELINE_EXECUTION_ERROR_TOPIC = readEnvOrDie(
...
export const AMQP_PIPELINE_CONFIG_UPDATED_TOPIC = readEnvOrDie(
...
export const AMQP_DATASOURCE_EXECUTION_EXCHANGE = readEnvOrDie(
  'AMQP_DATASOURCE_EXECUTION_EXCHANGE',
);
export const AMQP_DATASOURCE_EXECUTION_QUEUE = readEnvOrDie(
  'AMQP_DATASOURCE_EXECUTION_QUEUE',
);
export const AMQP_DATASOURCE_EXECUTION_QUEUE_TOPIC = readEnvOrDie(
  'AMQP_DATASOURCE_EXECUTION_QUEUE_TOPIC',
);
export const AMQP_DATASOURCE_EXECUTION_SUCCESS_TOPIC = readEnvOrDie(
